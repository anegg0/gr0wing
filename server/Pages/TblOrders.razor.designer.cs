...
namespace Growing.Pages
{
    public partial class TblOrdersComponent : ComponentBase
    {
        ...
        protected RadzenGrid<Growing.Models.Growing.TblOrder> grid0;

        IEnumerable<Growing.Models.Growing.TblOrder> _getTblOrdersResult;
        protected IEnumerable<Growing.Models.Growing.TblOrder> getTblOrdersResult
        {
            get
            {
        ...
        protected async System.Threading.Tasks.Task Grid0RowSelect(Growing.Models.Growing.TblOrder args)
        {
